...
public interface BillRepository extends JpaRepository<Bill, Long> {
        ...
        // ✅ Fetch bills generated by a specific employee within a date range for
        // commission calculation
        @Query("SELECT b FROM Bill b WHERE b.generatedBy = :generatedBy AND b.billingDate >= :startDate AND b.billingDate <= :endDate")
        List<Bill> findBillsByGeneratedByAndDateRange(
