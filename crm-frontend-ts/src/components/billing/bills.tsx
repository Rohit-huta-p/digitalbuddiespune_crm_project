      ...
      <Dialog>
        ...
        <DialogContent className="sm:max-w-[625px]">
          ...
          <Card className="mx-auto max-w-[825px]">
            ...
            <CardContent className="space-y-5 h-[65vh] overflow-y-auto">
              <div className="flex flex-col md:flex-row gap-5 w-full">
                <div className="space-y-5 flex-1">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Input id="amount" type="number" placeholder="Billing Amount" value={billData.amount} onChange={handleChange("amount")} />
                  </div>
                  <div className="flex flex-col gap-3">
                    <Label htmlFor="taxAmount">Tax Amount</Label>
                    <Input id="taxAmount" type="number" placeholder="Tax Amount" value={billData.taxAmount} onChange={handleChange("taxAmount")} />
                  </div>
                  <div className="flex flex-col gap-3">
                    <Label htmlFor="discountAmount">Discount Amount</Label>
                    <Input id="discountAmount" type="number" placeholder="Discount Amount" value={billData.discountAmount} onChange={handleChange("discountAmount")} />
                  </div>
                </div>
                <div className="space-y-5 flex-1">
                  <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Select value={billData.paymentMethod} onValueChange={(val) => setBillData((prev) => ({ ...prev, paymentMethod: val }))}>
                      <SelectTrigger>
              ...
              <div className="flex flex-col gap-3">
                ...
                <Textarea id="billingAddress" placeholder="Customer Billing Address" value={billData.billingAddress} onChange={(e) => setBillData((prev) => ({ ...prev, billingAddress: e.target.value }))} />
              </div>
              <div className="flex flex-col gap-3">
                <Label htmlFor="notes">Notes / Terms</Label>
                <Textarea id="notes" placeholder="Additional Notes or Terms" value={billData.notes} onChange={(e) => setBillData((prev) => ({ ...prev, notes: e.target.value }))} />
              </div>
